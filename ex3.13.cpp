/******************************************************************************
(Financial application: compute taxes) Listing 3.3, ComputeTax.ccp, gives the
source code to compute taxes for single filers. Complete listing 3.3 to give 
...
int main(){
    ...
    cout << "(0 - Single Filer, 1 - Married Jointly, or qualifying " << endl
         << "widow, 2 - Married Separately, 3 - Head of Household)" << endl
    ...
    // Compute tax for head of household
        ...
        if (income <= 11950)
            ...
            * 0.25 + (income - 117450) * 0.28;
            ...
            tax = 11950 * 0.10 + (45500 - 11950) * 0.15 + (117450 - 45500)
            * 0.25 + (190200 - 117450) * 0.28 + (income - 190200) * 0.33;
